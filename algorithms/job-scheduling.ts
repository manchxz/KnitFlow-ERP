/**
 * Job Scheduler - Priority Queue using Min-Heap
 *
 * Problem: 20 pending orders, 8 machines, 15 operators - which job first?
 * Solution: Min-Heap prioritizes by deadline + customer importance
 */
...
class JobScheduler {
  ...
  // Check next job without removing
  peek(): JobCard | null {
  ...
  // Compare jobs - lower number = higher priority
